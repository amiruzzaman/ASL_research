...
import time
from models.signtogloss.preprocess import get_data
...
def train(args):
    ...
    EPOCHS = args.epochs
    curr_epoch = 1
    model = SignToGlossModel(len(gloss_vocab), len(text_vocab), args.dmodel, args.heads, args.encoders, args.decoders, device=DEVICE).to(DEVICE)
